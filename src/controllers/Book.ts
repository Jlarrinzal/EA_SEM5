...
const readBookCategory = (req: Request, res: Response, next: NextFunction) => {
...
export default { createBook, readBook, readBookCategory, readAll, readAllA, updateBook, deleteBook };
